...
DROP VIEW IF EXISTS macro_totals_monthly, macro_totals_weekly, macro_totals_today, net_calories_per_day, calories_in_per_day, calories_out_per_day, current_weight, workout_calories_burned;
